...
//functions
jsSystem.validDependencyBlob = function (version){
...
function toRgb16(rgb24Color){
   var newColor;
   newColor = (rgb24Color >> 19 & 0x001F) << 11;//r
   newColor |= (rgb24Color >> 10 & 0x003F) << 5;//g
   newColor |= rgb24Color >> 3 & 0x001F;//b
   return newColor;
}
